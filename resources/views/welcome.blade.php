...
<body class="bg-[#F9F9F9]">
    ...
    <nav class="p-6 flex justify-between items-center bg-white shadow-sm">
        ...
        <div>
            <a href="{{ route('admin.dashboard') }}" class="bg-[#7E8959] text-white px-6 py-2 rounded-full font-semibold hover:bg-[#6B754D] transition">
                Masuk Dashboard 
            </a>
        </div>
    </nav>
    ...
    <section class="flex flex-col items-center justify-center min-h-[80vh] text-center px-4">
        ...
        <div class="flex gap-4">
            <a href="{{ route('login') }}" class="bg-[#7E8959] text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg shadow-[#7e8959]/30 hover:-translate-y-1 transition-all">
                Buka Panel Admin
            </a>
